...
type ModelType = "logistic" | "decision" | "svm" | "random" | "neural";
...
function PredictionForm() {
  ...
  const [selectedModel, setSelectedModel] = useState<ModelType>("decision");
  ...
  const models = [
    {
      ...
      icon: LineChart,
      endpoint: "http://localhost:5000/api/models/logistic-regression/predict",
    },
    {
      id: "decision",
      name: "Decision Tree",
      icon: GitBranch,
      endpoint: "http://localhost:5000/api/models/decision-tree/predict",
    },
    {
      id: "svm",
    ...
    },
    {
      ...
      name: "Random Forest",
      icon: Trees,
      endpoint: "http://localhost:5000/api/models/random-forest/predict",
    },
    {
      id: "neural",
      name: "K nearest neighbourest",
      icon: Network,
      endpoint: "http://localhost:5000/api/models/knn/predict",
    },
  ];
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleInputChange}
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-indigo-500 focus:border-indigo-500"
                  placeholder="Enter maneuver type"
                  required
                />
              </div>
              <div>
